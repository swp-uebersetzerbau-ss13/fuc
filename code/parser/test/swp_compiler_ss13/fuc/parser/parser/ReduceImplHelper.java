...
public class ReduceImplHelper {
	...
	protected Object getNotEqualOp(Object identifier1, Object identifier2) {
		...
		addAfter(equalop, ((ASTNode)identifier1).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.equality2);
		return action.create(identifier1, equalop, identifier2);
	}
	...
	protected Object getAdditionOp(Object expr1, Object expr2) {
		...
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.expr1);
	...
	protected Object getSubtractionOp(Object expr1, Object expr2) {
		...
		addAfter(binop, ((ASTNode)expr1).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.expr2);
		return action.create(expr1, binop, expr2);
	}
	...
	protected Object getMultiplicationOp(Object expr1, Object expr2) {
		...
		addAfter(binop, ((ASTNode)expr1).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.term1);
		return action.create(expr1, binop, expr2);
	}
	...
	protected Object getDivisionOp(Object expr1, Object expr2) {
		...
		addAfter(binop, ((ASTNode)expr1).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.term2);
		return action.create(expr1, binop, expr2);
	}
	...
	protected Object getNotOp(Object expr1) {
		...
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.unary1);
	...
	protected Object getMinusOp(Object expr1) {
		...
		addBefore(unop, ((ASTNode)expr1).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.unary2);
		return action.create(unop,expr1);
	}
	...
	protected Object getReturn(Object identifier) {
		...
		if(identifier == null){
			coverage.add(ret);
			coverage.add(sem);
			ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.stmt6);
			...
			ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.stmt10);
	...
	protected Object getPrint(Object identifier) {
		...
		addAfter(sem, ((ASTNode)identifier).coverage());
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.stmt7);
	...
	protected Object getBreak() {
		...
		coverage.add(sem);
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.stmt5);
	...
	protected Object getRecord(Object decls) {
		...
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.type3);
	...
	protected Object getArrayAccess(Object identifier, Object assignment) {
		...
		ReduceAction action = reduceImpl.getReduceAction(ProjectGrammar.Complete.loc1);
