...
public class RelationTest {
	...
	public void setUp() throws IntermediateCodeGeneratorException {
		...
		astf.addAssignment(astf.newBasicIdentifier("r"), astf.newBinaryExpression(
				BinaryOperator.GREATERTHAN, astf.newBasicIdentifier("l"),
		...
		astf2.addAssignment(astf2.newBasicIdentifier("r"), astf2.newBinaryExpression(
				BinaryOperator.LESSTHAN, astf2.newBasicIdentifier("l"),
		...
		astf3.addAssignment(astf3.newBasicIdentifier("g"), astf3.newLiteral("10", new DoubleType()));
		astf3.addAssignment(astf3.newBasicIdentifier("r"), astf3.newBinaryExpression(
				BinaryOperator.GREATERTHAN, astf3.newBasicIdentifier("g"),
				astf3.newLiteral("5", new DoubleType())));
		this.astDGreater = astf3.getAST();

		ASTFactory astf4 = new ASTFactory();
		astf4.addDeclaration("l", new DoubleType());
		astf4.addDeclaration("r", new BooleanType());
		astf4.addAssignment(astf4.newBasicIdentifier("l"), astf4.newLiteral("10", new DoubleType()));
		astf4.addAssignment(astf4.newBasicIdentifier("r"), astf4.newBinaryExpression(
				BinaryOperator.LESSTHAN, astf4.newBasicIdentifier("l"),
				astf4.newLiteral("5", new DoubleType())));
		this.astDLess = astf4.getAST();

		ASTFactory astf5 = new ASTFactory();
		astf5.addDeclaration("l", new LongType());
		astf5.addDeclaration("r", new BooleanType());
		astf5.addAssignment(astf5.newBasicIdentifier("l"), astf5.newLiteral("10", new LongType()));
		astf5.addAssignment(
				astf5.newBasicIdentifier("r"),
				astf5.newBinaryExpression(BinaryOperator.GREATERTHANEQUAL,
						astf5.newBasicIdentifier("l"), astf5.newLiteral("5", new LongType())));
		this.astGreaterE = astf5.getAST();

		ASTFactory astf6 = new ASTFactory();
		astf6.addDeclaration("l", new LongType());
		astf6.addDeclaration("r", new BooleanType());
		astf6.addAssignment(astf6.newBasicIdentifier("l"), astf6.newLiteral("10", new LongType()));
		astf6.addAssignment(
				astf6.newBasicIdentifier("r"),
				astf6.newBinaryExpression(BinaryOperator.LESSTHANEQUAL,
						astf6.newBasicIdentifier("l"), astf6.newLiteral("5", new LongType())));
		this.astLessE = astf6.getAST();

		ASTFactory astf7 = new ASTFactory();
		astf7.addDeclaration("g", new DoubleType());
		astf7.addDeclaration("r", new BooleanType());
		astf7.addAssignment(astf7.newBasicIdentifier("g"), astf7.newLiteral("10", new DoubleType()));
		astf7.addAssignment(
				astf7.newBasicIdentifier("r"),
				astf7.newBinaryExpression(BinaryOperator.GREATERTHANEQUAL,
						astf7.newBasicIdentifier("g"), astf7.newLiteral("5", new DoubleType())));
		this.astDGreaterE = astf7.getAST();

		ASTFactory astf8 = new ASTFactory();
		astf8.addDeclaration("l", new DoubleType());
		astf8.addDeclaration("r", new BooleanType());
		astf8.addAssignment(astf8.newBasicIdentifier("l"), astf8.newLiteral("10", new DoubleType()));
		astf8.addAssignment(
				astf8.newBasicIdentifier("r"),
				astf8.newBinaryExpression(BinaryOperator.LESSTHANEQUAL,
						astf8.newBasicIdentifier("l"), astf8.newLiteral("5", new DoubleType())));
		this.astDLessE = astf8.getAST();

		ASTFactory astf9 = new ASTFactory();
		astf9.addDeclaration("l", new LongType());
		astf9.addDeclaration("r", new BooleanType());
		astf9.addAssignment(astf9.newBasicIdentifier("l"), astf9.newLiteral("10", new LongType()));
		astf9.addAssignment(astf9.newBasicIdentifier("r"), astf9.newBinaryExpression(
				BinaryOperator.EQUAL, astf9.newBasicIdentifier("l"),
				astf9.newLiteral("5", new LongType())));
		this.astEqual = astf9.getAST();
		...
		astf10.addAssignment(astf10.newBasicIdentifier("r"), astf10.newBinaryExpression(
				BinaryOperator.EQUAL, astf10.newBasicIdentifier("g"),
				astf10.newLiteral("5", new DoubleType())));
		this.astDEqual = astf10.getAST();
		...
		astf11.addAssignment(astf11.newBasicIdentifier("r"), astf11.newBinaryExpression(
				BinaryOperator.INEQUAL, astf11.newBasicIdentifier("l"),
				astf11.newLiteral("5", new LongType())));
		this.astInEqual = astf11.getAST();
		...
		astf12.addAssignment(astf12.newBasicIdentifier("r"), astf12.newBinaryExpression(
				BinaryOperator.ADDITION, astf12.newBasicIdentifier("l"),
				astf12.newLiteral("5", new LongType())));
		this.astEX = astf12.getAST();
	}
	...
	public void testDGreater() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astDGreater);
	...
	public void testDLess() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astDLess);
	...
	public void testDGreaterE() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astDGreaterE);
	...
	public void testDLessE() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astDLessE);
	...
	public void testLGreaterE() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astGreaterE);
	...
	public void testLLessE() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astLessE);
	...
	public void testDEqual() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astDEqual);
	...
	public void testEqual() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astEqual);
	...
	public void testInEqual() throws IntermediateCodeGeneratorException {
		IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
		List<Quadruple> irc = irg.generateIntermediateCode(this.astInEqual);
		...
		String expected = "(DECLARE_LONG|!|!|l)" + "\n" + "(DECLARE_BOOLEAN|!|!|r)" + "\n"
				...
				+ "(NOT_BOOLEAN|tmp0|!|tmp1)" + "\n" + "(ASSIGN_BOOLEAN|tmp1|!|r)" + "\n";
	...
	public void testEX() {
		try {
			IntermediateCodeGeneratorImpl irg = new IntermediateCodeGeneratorImpl();
			List<Quadruple> irc = irg.generateIntermediateCode(this.astEX);
