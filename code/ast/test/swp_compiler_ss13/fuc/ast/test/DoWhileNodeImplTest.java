...
public class DoWhileNodeImplTest {

	private DoWhileNode node = new DoWhileNodeImpl();

	@Before
	public void setUp() throws Exception {
		this.node = new DoWhileNodeImpl();
	}

	@Test
	public void testGetNodeType() {
		assertEquals(ASTNodeType.DoWhileNode, this.node.getNodeType());
	}
