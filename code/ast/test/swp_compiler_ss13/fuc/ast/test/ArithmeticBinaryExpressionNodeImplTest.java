...
public class ArithmeticBinaryExpressionNodeImplTest {
	...
	public void testSetLeftValue() {
		...
		ExpressionNode actualExpression = (ExpressionNode) PA.getValue(this.node, "leftExpression");
	...
	public void testSetOperator() {
		...
		assertEquals(BinaryOperator.LESSTHAN, PA.getValue(this.node, "operator"));
		...
		assertEquals(BinaryOperator.DIVISION, PA.getValue(this.node, "operator"));
	}
