...
public class ControlAndIOTest extends TestBase {
	...
	public void generateTargetCodeTest_BranchTrue() throws IOException, BackendException {
		...
		String dataSegment = "@.string_0 = constant [12 x i8][i8 116, i8 114, i8 117, i8 101, i8 32, i8 98, i8 114, i8 97, i8 110, i8 99, i8 104, i8 0]\n@.string_1 = constant [13 x i8][i8 102, i8 97, i8 108, i8 115, i8 101, i8 32, i8 98, i8 114, i8 97, i8 110, i8 99, i8 104, i8 0]\n";
		String mainFunctionCode = "  %cond = alloca i1\n  store i1 1, i1* %cond\n  %cond.0 = load i1* %cond\n  br i1 %cond.0, label %true, label %false\n  true:\n  %.tmp.0 = getelementptr [12 x i8]* @.string_0, i64 0, i64 0\n  call i32 (i8*, ...)* @printf(i8* %.tmp.0)\n  br label %end\n  false:\n  %.tmp.1 = getelementptr [13 x i8]* @.string_1, i64 0, i64 0\n  call i32 (i8*, ...)* @printf(i8* %.tmp.1)\n  br label %end\n  end:\n  ret i64 0\n";
	...
	public void generateTargetCodeTest_PrintString() throws IOException, BackendException {
		...
		String dataSegment = "@.string_0 = constant [4 x i8][i8 98, i8 108, i8 97, i8 0]\n";
		String mainFunctionCode = "  %s1 = alloca i8*\n  %s1.0 = getelementptr [4 x i8]* @.string_0, i64 0, i64 0\n  store i8* %s1.0, i8** %s1\n  %s1.1 = load i8** %s1\n  call i32 (i8*, ...)* @printf(i8* %s1.1)\n  ret i64 0\n";
		expectMain(dataSegment, mainFunctionCode, generateCodeAsString(tac));
	}
