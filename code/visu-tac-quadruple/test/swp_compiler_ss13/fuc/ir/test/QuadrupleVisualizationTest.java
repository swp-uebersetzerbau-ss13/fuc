...
import swp_compiler_ss13.fuc.ir.visualization.TACConsoleVisualizationQuadruple;
import swp_compiler_ss13.fuc.symbolTable.SymbolTableImpl;

public class QuadrupleVisualizationTest {
	...
	public void test() throws IntermediateCodeGeneratorException {
		...
		new TACConsoleVisualizationQuadruple().visualizeTAC(tac);
	}
}
